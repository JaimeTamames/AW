...
/**
 * Manejador que muestra las respuestas a una pregunta para adivinar a un amigo
 * Muestra un numero determinado de respuestas incluyendo la que ha elegido el amigo previamente
 */
app.get("/guessAnswer.html/:id", (request, response) => {
